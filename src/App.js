	...
	return (
		<div className="App">
			...
			<form>
				<div className="exposure-1">
					...
					<label htmlFor="apeture_1">
						...
						>
							<option
								onClick={() => setApeture_1(1.4)}
								value="1.4"
							>
								1.4
							</option>
							<option
								onClick={() => setApeture_1(1.8)}
								value="1.8"
							>
								1.8
							</option>
							<option
								onClick={() => setApeture_1(2.8)}
								value="2.8"
							>
								2.8
							</option>
							<option onClick={() => setApeture_1(4)} value="4">
								4
							</option>
							<option
								onClick={() => setApeture_1(5.6)}
								value="5.6"
							>
								5.6
							</option>
							<option onClick={() => setApeture_1(8)} value="8">
								8
							</option>
							<option onClick={() => setApeture_1(11)} value="11">
								11
							</option>
							<option onClick={() => setApeture_1(16)} value="16">
								16
							</option>
							<option onClick={() => setApeture_1(22)} value="22">
								22
							</option>
						</select>
					</label>
				...
				<div className="exposure-2">
					...
					<label htmlFor="apeture_2">
						...
						>
							<option
								onClick={() => setApeture_2(1.4)}
								value="1.4"
							>
								1.4
							</option>
							<option
								onClick={() => setApeture_2(1.8)}
								value="1.8"
							>
								1.8
							</option>
							<option
								onClick={() => setApeture_2(2.8)}
								value="2.8"
							>
								2.8
							</option>
							<option onClick={() => setApeture_2(4)} value="4">
								4
							</option>
							<option
								onClick={() => setApeture_2(5.6)}
								value="5.6"
							>
								5.6
							</option>
							<option onClick={() => setApeture_2(8)} value="8">
								8
							</option>
							<option onClick={() => setApeture_2(11)} value="11">
								11
							</option>
							<option onClick={() => setApeture_2(16)} value="16">
								16
							</option>
							<option onClick={() => setApeture_2(22)} value="22">
								22
							</option>
						</select>
					</label>
			...
			{exposure_1 >= exposure_2 ? (
				<>
					Exposure 1 is {exposure_1 / exposure_2} stops brighter than
					exposure 2
				</>
			) : (
				<>
					Exposure 2 is {exposure_2 / exposure_1} stops brighter than
					exposure 1
				</>
			)}
		</div>
